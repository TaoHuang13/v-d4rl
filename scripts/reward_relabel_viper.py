...
def main(cfgs):
    device = 'cuda'
    cfgs.reward.cfg_path = '/home/lucas/eccv/diffusion_reward/exp_local/video_models/videogpt/dmc/.hydra/config.yaml'
    cfgs.reward.ckpt_path = '/home/lucas/eccv/diffusion_reward/exp_local/video_models/videogpt/dmc/results/checkpoints/videogpt.pt'
    ...
    output_dir = f'/home/lucas/eccv/v-d4rl/vd4rl_data/main/{task}/{data_type}/viper_relabel'
    ...
    for end_idx in end_idxes:
        ...
        # TODO!, add statistics
        rewards[start_idx:end_idx] = pred_rewards.cpu().numpy()[:,0]
        start_idx = end_idx + 1
